...
const EmployeeSidebar = ({ isCollapsed, setIsCollapsed, isMobile, onClose }) => {
  ...
  const buildElements = () => {
    ...
    // 8. EXPENSE MANAGEMENT - STANDALONE ITEM (ALAG SE)
    ...
    // 10. SHIFTS (Standalone - agar alag chahiye)
  ...
  console.log("📊 Final Elements:", elements.map(e => ({ 
    name: e.name, 
    type: e.dropdown ? "dropdown" : "link",
    items: e.dropdown ? e.dropdown.map(d => d.name) : []
  })));
