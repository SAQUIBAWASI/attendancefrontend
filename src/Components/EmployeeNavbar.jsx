...
//   return (
//     <nav className="bg-[#1D4ED8] border-blue-800/50 border-blue-800/50 text-white sticky top-0 w-full h-16 px-4 flex items-center  z-50">
...
//           {unreadCount > 0 && (
//             <span className="absolute flex items-center justify-center w-4 h-4 text-xs font-bold text-white bg-[#1E3A8A] rounded-full -top-1 -right-1">
//               {unreadCount}
//             </span>
//           )}
//         </button>
...
//           {isLoading && (
//             <span className="absolute flex items-center justify-center w-4 h-4 text-xs font-bold text-white bg-[#1D4ED8] rounded-full -top-1 -right-1">
//               ...
//             </span>
//           )}
//         </button>
...
const EmployeeNavbar = ({ isCollapsed, setIsCollapsed }) => {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      window.removeEventListener('viewChanged', handleStorageChange);
    };
  }, []);
  ...
  const getPageTitle = () => {
    ...
    const defaultTitle = isAdminView ? "Admin Dashboard" : "Employee Dashboard";
    return titles[path] || defaultTitle;
  };
