...
//         <div>
//           <h1 className="text-3xl font-bold text-gray-700">Shifts</h1>
//           {/* <p className="text-gray-500">Supporting A-Z shift types with legacy data</p> */}
//         </div>
//         <div className="flex gap-3">
//           {/* <button
...
//                           <div key={slot.slotId} className="flex items-center gap-1 text-xs text-gray-500">
...
//         <div className="mt-8">
//           <h2 className="mb-4 text-xl font-bold text-gray-700">All Assigned Employees ({employeeAssignments.length})</h2>
...
//               <button onClick={() => setShowCreateModal(false)} className="text-2xl text-gray-500 hover:text-gray-500">
//                 &times;
//               </button>
//             </div>
...
//               <button onClick={() => setShowCustomCreateModal(false)} className="text-2xl text-gray-500 hover:text-gray-500">
//                 &times;
//               </button>
//             </div>
...
//                       <div key={slot.slotId} className="p-3 bg-white border rounded-lg">
...
//               </h3>
//               <button onClick={() => setShowAssignModal(false)} className="text-2xl text-gray-500 hover:text-gray-500">
//                 &times;
//               </button>
//             </div>
...
//                 className="text-2xl text-gray-500 hover:text-gray-500"
//               >
//                 &times;
//               </button>
//             </div>
...
//               <button
//                 onClick={() => setShowViewModal(false)}
//                 className="w-full py-2.5 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 text-sm font-medium"
//               >
//                 Close
//               </button>
//             </div>
...
//       <div className="flex flex-col items-start justify-between gap-4 mb-6 md:flex-row md:items-center">
//         <div>
//           <h1 className="text-3xl font-bold text-gray-700">Shift Management</h1>
//           <p className="text-gray-500">One time slot per shift</p>
//         </div>
...
//           <h2 className="text-xl font-bold text-gray-700">Available Shifts ({masterShifts.length})</h2>
...
//         <div className="mb-8">
//           <div className="flex items-center justify-between mb-4">
//             <h2 className="text-xl font-bold text-gray-700">All Assigned Employees ({employeeAssignments.length})</h2>
...
//                   <div className="p-3 space-y-3 bg-white border rounded-lg">
//                     <div>
//                       <label className="block mb-1 text-xs text-gray-500">Time Range *</label>
//                       <input
//                         type="text"
...
//                         </td>
//                         <td className="px-4 py-3">
//                           <div className="text-sm text-gray-500">{emp.employeeAssignment?.selectedDescription || "Legacy shift"}</div>
//                         </td>
//                         <td className="px-4 py-3">
//                           <div className="flex gap-2">
//                             <button
...
//         <div>
//           <h1 className="text-3xl font-bold text-gray-700">Shift Management</h1>
//           <p className="text-gray-500">Active employees only</p>
//         </div>
//         <div className="flex flex-wrap gap-3">
//           {masterShifts.length === 0 && (
//             <button
...
//         <div className="mb-8">
//           <div className="flex items-center justify-between mb-4">
//             <h2 className="text-xl font-bold text-gray-700">Active Assigned Employees ({employeeAssignments.length})</h2>
...
//     return colorMap[type] || "bg-gray-100 text-gray-700 border border-gray-200";
//   };
...
//         <div>
//           <h1 className="text-3xl font-bold text-gray-700">Shifts</h1>
//           {/* <p className="text-gray-500">Manage employee shifts and assignments</p> */}
//         </div>
...
//         <div className="mb-8">
//           <div className="flex items-center justify-between mb-4">
//             <h2 className="text-xl font-bold text-gray-700">Assigned Employees ({employeeAssignments.length})</h2>
...
//               <button onClick={() => setShowCustomCreateModal(false)} className="text-xl text-gray-500 transition-colors hover:text-gray-500">
//                 &times;
//               </button>
//             </div>
...
//               <button onClick={() => setShowBrakeShiftModal(false)} className="text-xl text-gray-500 transition-colors hover:text-gray-500">
//                 &times;
//               </button>
//             </div>
...
//                         <p className="text-xs text-gray-500">First shift before break</p>
//                       </div>
//                     </div>
...
//                       </div>
//                       <div>
//                         <p className="text-sm text-gray-700">17:00 - 21:30</p>
//                         <p className="text-xs text-gray-500">Second shift after break</p>
//                       </div>
//                     </div>
...
//                 {editingAssignment ? 'Edit Assignment' : 'Assign Shift'}
//               </h3>
//               <button onClick={() => setShowAssignModal(false)} className="text-xl text-gray-500 transition-colors hover:text-gray-500">
//                 &times;
//               </button>
//             </div>
...
//               <button
//                 onClick={() => setShowViewModal(false)}
//                 className="text-xl text-gray-500 transition-colors hover:text-gray-500"
//               >
//                 &times;
//               </button>
//             </div>
...
//                     <th className="px-4 py-3 text-xs font-semibold tracking-wider text-left text-gray-500 uppercase">Time Slot</th>
//                     <th className="px-4 py-3 text-xs font-semibold tracking-wider text-left text-gray-500 uppercase">Description</th>
//                     <th className="px-4 py-3 text-xs font-semibold tracking-wider text-left text-gray-500 uppercase">Actions</th>
//                   </tr>
//                 </thead>
//                 <tbody className="divide-y divide-gray-200">
//                   {viewEmployees.map((emp) => {
...
//             <h1 className="text-xl font-bold text-gray-700">Shifts</h1>
...
//         <div className="mb-6">
//           {/* <h2 className="mb-3 text-lg font-semibold text-gray-700">Available Shifts ({masterShifts.length})</h2> */}

//           {masterShifts.length === 0 ? (
//             <div className="py-8 text-center bg-white border border-gray-200 rounded-lg">
//               <div className="mb-3 text-4xl text-gray-500">⏰</div>
//               <h3 className="mb-1 text-base font-semibold text-gray-500">No shifts created yet</h3>
...
//         {employeeAssignments.length > 0 && (
//           <div className="mb-6">
//             {/* <h2 className="mb-3 text-lg font-semibold text-gray-700">Assigned Employees ({employeeAssignments.length})</h2> */}
...
//                         </div>
//                         <span className="text-[10px] text-gray-700">17:00 - 21:30</span>
//                       </div>
//                       <p className="text-[9px] text-gray-500">Total: 10.5 hours with break</p>
//                     </div>
//                   </div>
...
//     "K": "bg-gray-200 text-gray-700 border border-gray-300"
...
//     shiftType: '',
//     shiftName: '',
//     shiftCategory: 'Regular', // New field for shift category
//     timeSlots: [{ slotId: `${Date.now()}_1`, startTime: '', endTime: '', timeRange: '', description: '' }],
//     isBrakeShift: false
//   });
...
//                       {masterShifts.map(shift => (
//                         <option key={shift._id} value={shift.shiftType}>
//                           Shift {shift.shiftType}: {shift.shiftName} ({shift.shiftCategory || 'Regular'}) {shift.isBrakeShift && '(Brake)'}
//                         </option>
//                       ))}
//                     </select>
  ...
  return (
    <div className="min-h-screen px-2 py-2 bg-gradient-to-br from-green-50 to-blue-100">
      <div className="mx-auto max-w-9xl">
        ...
        {/* ASSIGN SHIFT MODAL - WITH TIME IN DROPDOWN */}
        {showAssignModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50">
            <div className="w-full max-w-md bg-white rounded-lg shadow-xl">
              <div className="flex items-center justify-between p-3 border-b">
