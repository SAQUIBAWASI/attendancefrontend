...
const ScoreTooltip = ({ active, payload }) => {
  if (active && payload && payload.length) {
    ...
    return (
      <div className="px-3 py-2 text-xs bg-white border border-gray-200 rounded-lg shadow-xl">
        <p className="font-bold text-gray-700 mb-0.5 leading-none">{data.range}</p>
...
const RecruitmentDashboard = () => {
  ...
  return (
    <div className="min-h-screen p-2 lg:p-6 bg-white/50">
      ...
      <div className="grid grid-cols-1 gap-4 mb-4 lg:grid-cols-2">
        ...
        <div className="bg-white px-2 py-2 rounded-2xl shadow-sm border border-gray-200 flex flex-col h-[400px]">
          <div className="flex items-center justify-between mb-3 px-2">
            <div>
              <h3 className="text-base font-bold text-gray-700"> Applicants Status</h3>
        ...
        <div className="bg-white px-2 py-2 rounded-2xl shadow-sm border border-gray-200 flex flex-col h-[400px]">
          <div className="flex items-center justify-between mb-3 px-2">
            <div>
              <h3 className="text-base font-bold text-gray-700">Score Distribution</h3>
      ...
      <div className="grid grid-cols-1 gap-8 mb-8 lg:grid-cols-2">
        ...
        <div className="bg-white px-4 py-4 rounded-2xl shadow-sm border border-gray-200 flex flex-col h-[400px]">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="text-base font-bold text-gray-700">Quality Metrics</h3>
        ...
        <div className="bg-white px-2 py-2 rounded-2xl shadow-sm border border-gray-200 flex flex-col h-[400px]">
          <div className="flex items-center justify-between mb-3 px-2">
            <div>
              <h3 className="text-base font-bold text-gray-700">Hiring TAT (Days)</h3>
      ...
      <div className="bg-white px-2 py-2 rounded-2xl shadow-sm border border-gray-200 flex flex-col h-[300px] mb-4">
        <div className="flex items-center justify-between mb-3 px-2 flex-wrap gap-2">
          <div>
            <h3 className="text-base font-bold text-gray-700">Monthly Application Trend</h3>
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {trendMonth && (
              <button
                ...
                className="text-[10px] font-bold text-gray-500 hover:text-rose-500 transition-colors"
