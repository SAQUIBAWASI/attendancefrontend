...
//       <FiCalendar className="text-sm text-gray-400" />
//       <input
//         type="date"
//         value={lateDate}
...
//     if (percentage >= 50) return '#eab308'; // Amber 500
...
//   return (
//     <div className="min-h-screen p-4 lg:p-8 bg-gray-50/50">
//       {/* 1. Top Summary Stats - Smaller Cards */}
//       <div className="grid grid-cols-1 gap-3 mb-8 sm:grid-cols-2 lg:grid-cols-5">
//         <StatCard
//           icon={FiUsers}
...
//   return (
//     <div
//       className="flex flex-row items-center gap-2 p-2 transition-all duration-300 bg-white rounded-lg shadow-sm border border-gray-100 cursor-pointer hover:shadow-md hover:translate-y-[-2px] active:scale-95 group"
//       onClick={onClick}
//     >
//       <div className={`w-7 h-7 flex-shrink-0 flex items-center justify-center rounded-md transition-colors ${themes[color]} group-hover:bg-white`}>
//         <Icon className="text-sm" />
//       </div>
//       <div className="flex flex-col min-w-0">
//         <p className="text-[10px] font-bold tracking-wider text-gray-400 uppercase truncate">{label}</p>
//         <p className="text-base font-black leading-tight text-gray-800">
//           {typeof value === 'string' && value.includes('%') ? (
//             value
//           ) : (
//             <CountUp end={parseFloat(value)} duration={2} />
