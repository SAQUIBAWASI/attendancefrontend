...
//   return (
//     <div className="w-full min-h-screen bg-[#000000]/50 p-4 md:p-6 lg:p-8 animate-in fade-in duration-500">
...
//           </div>
//           <h2 className="text-xl font-bold text-gray-300">Employee Journeys</h2>
//         </div>
...
//                   <input
//                     type="text"
//                     className="w-full py-1.5 px-3 text-xs bg-[#0a0a0a] border border-[#1f2937] rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
...
//                   <div
//                     className={`px-4 py-2 text-xs font-bold cursor-pointer hover:bg-blue-50 transition-colors ${!roleFilter ? 'text-blue-600 bg-blue-50' : 'text-gray-400'}`}
...
//                       <div
//                         key={i}
//                         className={`px-4 py-2 text-xs font-bold cursor-pointer hover:bg-blue-50 transition-colors ${roleFilter === r.name ? 'text-blue-600 bg-blue-50' : 'text-gray-400'}`}
...
//             <input
//               type="text"
//               className="w-full py-2 pl-10 pr-10 text-sm text-gray-300 border border-[#374151] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm"
...
//               className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-400 bg-[#111111] hover:bg-[#1f2937] rounded-lg transition-colors"
//             >
...
//       <div className="overflow-x-auto bg-[#0a0a0a] shadow-xl rounded-2xl border border-[#1f2937]">
//         {loading ? (
//           <div className="flex flex-col justify-center items-center py-20 gap-3">
//             <div className="w-10 h-10 border-4 border-[#1f2937] border-t-blue-600 rounded-full animate-spin"></div>
...
//                 <th className="py-2 text-center">Contact Details</th>
//                 <th className="py-2 text-center">Roles Logged</th>
//                 <th className="py-2 text-center">System Status</th>
...
//                       <div className="text-gray-200 whitespace-nowrap">{item.candidate?.name || "Unknown"}</div>
...
//                   </td>
//                   <td className="px-2 py-2 font-medium text-center">
//                     <span className="inline-block px-3 py-1 bg-[#0a0a0a] border border-blue-100 text-blue-600 text-[10px] font-black uppercase tracking-widest rounded-full shadow-sm">
//                       {item.latestRole}
//                     </span>
//                     <div className="text-[10px] text-gray-400 mt-1 font-medium">{item.latestCompany}</div>
//                   </td>
//                   <td className="px-2 py-2 font-medium text-center">
...
//                   </td>
//                   <td className="px-2 py-2 font-medium text-center">
//                     <div className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-[#000000] text-gray-300 font-black text-xs border border-[#1f2937] shadow-inner group-hover:bg-blue-600 group-hover:text-white transition-all">
...
//             <div className="w-20 h-20 bg-[#000000] rounded-full flex items-center justify-center mx-auto mb-6 text-gray-200">
//               <FaBriefcase size={40} />
//             </div>
//             <h3 className="text-xl font-bold text-gray-300">No Journey Records Found</h3>
...
//           <div className="bg-[#0a0a0a] rounded-3xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col relative animate-in zoom-in-95 duration-300">
//             {/* Modal Header */}
...
//                 </div>
//                 <div>
//                   <h2 className="text-xl font-black text-gray-200 tracking-tight leading-tight">
...
//                 className="w-10 h-10 flex items-center justify-center rounded-xl bg-[#000000] text-gray-400 hover:bg-red-50 hover:text-red-500 transition-all border border-[#1f2937] hover:border-red-100"
//               >
//                 <FaTimes size={16} />
//               </button>
//             </div>
...
//             {/* Modal Body */}
//             <div className="flex-1 overflow-y-auto p-8 bg-[#000000]/30 no-scrollbar">
//               <div className="relative pl-8 border-l-[3px] border-dashed border-[#1f2937]/60 ml-4 space-y-12">
...
//                     <div className="bg-[#0a0a0a] rounded-3xl p-6 border border-[#1f2937] shadow-sm hover:border-blue-200 transition-all duration-300">
//                       <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6">
//                         <div className="space-y-6 flex-1">
//                           <div>
//                             <div className="flex items-center gap-4">
//                               <h5 className="text-lg font-black text-gray-200 tracking-tight">{exp.role}</h5>
...
//                             </div>
//                             <p className="text-gray-400 font-bold text-sm mt-1.5 flex items-center gap-2">
...
//                               target="_blank"
//                               rel="noreferrer"
//                               className="flex-1 lg:flex-none flex items-center justify-center gap-2.5 px-4 py-2 bg-[#000000] text-gray-300 hover:bg-blue-600 hover:text-white rounded-xl text-[9px] font-black uppercase tracking-widest transition-all border border-[#1f2937] hover:border-blue-600 shadow-sm"
//                             >
//                               <FaFilePdf size={12} /> Offer Letter
//                             </a>
//                           ) : (
//                             <div className="flex-1 lg:flex-none flex items-center justify-center gap-2.5 px-4 py-2 bg-[#000000]/50 text-gray-300 rounded-xl text-[9px] font-black uppercase tracking-widest border border-dashed border-[#1f2937]">
//                               No Letter
//                             </div>
//                           )}
//                           {
...
const EmployeeJourney = () => {
  ...
  }, [filteredCandidates.length, searchQuery, roleFilter, dateFilter]);
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-[#000000] to-[#0a0a0a] p-2 md:p-4 lg:p-6 animate-in fade-in duration-500">
      {/* Header */}
            ...
            {isRoleDropdownOpen && (
              <div className="absolute z-50 mt-1 w-48 bg-[#0a0a0a] border border-[#1f2937] rounded-md shadow-lg max-h-60 overflow-y-auto">
                <div className="p-2 border-b border-[#1f2937] bg-[#000000]">
                  <input
                    type="text"
                    className="w-full py-1 px-3 text-xs bg-[#0a0a0a] border border-[#1f2937] rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500"
                    placeholder="Search roles..."
                    value={roleSearchQuery}
                    onChange={(e) => setRoleSearchQuery(e.target.value)}
                    onClick={(e) => e.stopPropagation()}
              ...
              <div className="relative pl-8 border-l-[3px] border-dashed border-[#1f2937]/60 ml-4 space-y-12">
                {selectedCandidate.experiences.map((exp, eIdx) => (
                  <div key={eIdx} className="relative">
                    ...
                    <div className={`bg-[#0a0a0a] rounded-3xl p-6 border ${exp.isCurrentJob ? 'border-emerald-200 bg-emerald-50/20' : 'border-[#1f2937]'} shadow-sm hover:border-blue-200 transition-all duration-300`}>
                      <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6">
                        <div className="space-y-6 flex-1">
                          <div>
                            <div className="flex items-center gap-4">
