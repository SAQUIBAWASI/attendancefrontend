...
//             {dateFilter && (
//               <div
//                 className="absolute inset-y-0 right-0 flex items-center pr-3 cursor-pointer text-gray-500 hover:text-red-500"
...
//             </div>
//             <div className="absolute inset-y-0 right-0 flex items-center pr-3 z-10 text-gray-500">
...
//                   <div
//                     className={`px-4 py-2 text-xs font-bold cursor-pointer hover:bg-blue-50 transition-colors ${!roleFilter ? 'text-blue-600 bg-blue-50' : 'text-gray-500'}`}
...
//                       <div
//                         key={i}
//                         className={`px-4 py-2 text-xs font-bold cursor-pointer hover:bg-blue-50 transition-colors ${roleFilter === r.name ? 'text-blue-600 bg-blue-50' : 'text-gray-500'}`}
...
//             </div>
//             {searchQuery && (
//               <button onClick={() => setSearchQuery("")} className="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 hover:text-red-500">
...
//               className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-500 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors"
//             >
...
//                       <div className="text-gray-900 whitespace-nowrap">{item.candidate?.name || "Unknown"}</div>
...
//                       {item.latestRole}
//                     </span>
//                     <div className="text-[10px] text-gray-500 mt-1 font-medium">{item.latestCompany}</div>
//                   </td>
//                   <td className="px-2 py-2 font-medium text-center">
...
//             <p className="text-gray-500 mt-2 max-w-sm mx-auto text-sm font-medium">No candidate has documented their work professional history for this criteria.</p>
//           </div>
//         )}
//       </div>
...
//                     <div className="bg-white rounded-3xl p-6 border border-gray-200 shadow-sm hover:border-blue-200 transition-all duration-300">
...
//                             </div>
//                             <p className="text-gray-500 font-bold text-sm mt-1.5 flex items-center gap-2">
...
const EmployeeJourney = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-2 md:p-4 lg:p-6 animate-in fade-in duration-500">
      {/* Header */}
            ...
            {isRoleDropdownOpen && (
              <div className="absolute z-50 mt-1 w-48 bg-white border border-gray-200 rounded-md shadow-lg max-h-60 overflow-y-auto">
                ...
                <div
                  ...
                  className={`px-3 py-2 text-xs hover:bg-blue-50 cursor-pointer border-b border-gray-200 font-medium ${!roleFilter ? 'bg-blue-50 text-blue-700' : 'text-gray-700'
                    }`}
                >
                  All Roles
                </div>
