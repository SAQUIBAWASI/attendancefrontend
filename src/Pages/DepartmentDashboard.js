...
//         <div>
//           <h1 className="text-3xl font-bold text-gray-700">Department Management</h1>
//           <p className="text-gray-500">Manage all departments and view employees</p>
//         </div>
//         <button
//           onClick={handleAdd}
//           className="flex items-center gap-2 px-6 py-3 text-gray-900 bg-blue-600 rounded-lg hover:bg-blue-700"
//         >
...
//           <h3 className="mb-2 text-xl font-semibold text-gray-500">No departments found</h3>
...
//             <button
//               onClick={handleAdd}
//               className="px-6 py-2 text-gray-900 bg-blue-600 rounded-lg hover:bg-blue-700"
//             >
...
<div className="flex flex-col gap-4 mb-6 md:flex-row md:items-center md:justify-between">
  ...
  <button
    onClick={handleAdd}
    className="flex items-center justify-center gap-2 px-6 py-3 text-gray-900 bg-blue-600 rounded-lg hover:bg-blue-700"
  >
          ...
          <tbody>
            {filteredDepartments.map((department) => (
              <tr key={department._id} className="border-b hover:bg-gray-50">
                ...
                <td className="p-2">
                  <div className="max-w-md text-gray-500">{department.description}</div>
                </td>
                <td className="p-2">
      ...
      {filteredDepartments.length === 0 && (
        <div className="py-12 text-center bg-white border border-gray-200 rounded-lg">
          ...
          {!searchTerm && (
            <button
              onClick={handleAdd}
              className="flex items-center gap-2 px-6 py-2 mx-auto text-gray-900 bg-blue-600 rounded-lg hover:bg-blue-700"
            >
