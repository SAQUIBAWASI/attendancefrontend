...
//               LOG IN
//             </h1>
//             <p className="mt-1 text-sm text-gray-400">Admin • Employee • Client</p>
//           </div>
...
//                   loginType === 'email' 
//                     ? 'bg-[#0a0a0a] shadow text-blue-600' 
...
//                 className={`px-4 py-2 text-sm font-medium rounded-md transition-all duration-300 ${
//                   loginType === 'clientId' 
//                     ? 'bg-[#0a0a0a] shadow text-purple-600' 
//                     : 'text-gray-400 hover:text-gray-200'
//                 }`}
//               >
//                 Client ID
...
//                   className="w-full px-4 py-3 mt-1 text-sm border border-[#374151] rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
//                   required
//                 />
//               </div>
//             ) : (
//               <div>
//                 <label className="block text-sm font-medium text-gray-300" htmlFor="clientId">
//                   Client ID
//                 </label>
//                 <input
//                   type="text"
...
//                   className="w-full px-4 py-3 mt-1 text-sm border border-[#374151] rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
//                   required
//                 />
//               </div>
//             )}
...
//                   placeholder="••••••••"
//                   className="w-full px-4 py-3 pr-10 text-sm border border-[#374151] rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
//                   required
//                 />
//                 <button
//                   type="button"
      ...
      <div className="grid w-full max-w-5xl grid-cols-1 overflow-hidden shadow-xl bg-[#0a0a0a]/80 backdrop-blur-md rounded-2xl md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center p-8 md:p-12">
          <div className="mb-6 text-center">
            ...
            <p className="mt-1 text-sm text-gray-400">Unified Login Access</p>
          </div>
