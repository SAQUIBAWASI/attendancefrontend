...
import { FiCalendar, FiCheckCircle, FiClock, FiFilter, FiUsers, FiXCircle, FiTrash2 } from "react-icons/fi";
...
const Regularization = () => {
  ...
  const [itemsPerPage, setItemsPerPage] = useState(() => {
    const saved = localStorage.getItem('regularization_itemsPerPage');
  ...
  const handleItemsPerPageChange = (e) => {
    ...
    localStorage.setItem('regularization_itemsPerPage', String(newValue));
    setCurrentPage(1);
  };
    ...
    <div className="emp-dash">
      <main className="p-2 sm:p-4 lg:p-6">
        ...
        <div className="hidden lg:flex items-center justify-between gap-3 flex-wrap mb-4">
          ...
          {/* Right side: All Filters - Search, Department, Designation, Calendar */}
        ...
        <div className="lg:hidden flex items-center justify-between gap-2 flex-wrap mb-3">
          <h1 className="text-base font-bold whitespace-nowrap">
            Regularization <span className="text-indigo-600">Requests</span>
          </h1>
        </div>
