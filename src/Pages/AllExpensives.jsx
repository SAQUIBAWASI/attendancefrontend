          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="flex items-center gap-2 border border-gray-300 rounded-lg px-2 h-[30px] bg-gray-50">
              ...
              <input
                ...
                className="w-14 bg-transparent border-none text-xs font-bold text-gray-700 focus:ring-0 p-0 placeholder:text-gray-500 placeholder:font-normal"
              />
              <button
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {loading && expenses.length === 0 ? (
                  ...
                  <tr>
                    <td colSpan="6" className="px-2 py-2 text-center">
                      <div className="py-10">
                        <FaMoneyBillWave className="text-gray-700 text-3xl mx-auto mb-2" />
          ...
          <div className="bg-white w-full max-w-5xl max-h-[90vh] rounded-2xl shadow-2xl relative overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col border border-gray-200">
            ...
            <div className="px-8 py-6 bg-white border-b border-gray-200 flex items-center justify-between flex-shrink-0">
              ...
              <div className="flex items-center gap-8">
                <div className="text-right">
                  <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Total visits</p>
                  <p className="text-xl font-bold text-gray-900">{selectedGroup.visitCount}</p>
                </div>
                <div className="text-right">
                  <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1">Reimbursement</p>
            ...
            <div className="flex-1 overflow-y-auto p-0 bg-white">
                      ...
                      <tr className="hover:bg-blue-50/50 transition-colors group">
                        ...
                        <td className="px-6 py-4 text-gray-900 border-r border-gray-50">
                          <div className="flex flex-col">
                            ...
                            {rec.remark && <span className="text-[10px] text-gray-500 mt-1 italic font-medium">{rec.remark}</span>}
                        ...
                        <td className="px-6 py-4 text-right border-r border-gray-50 text-gray-500 text-xs font-bold whitespace-nowrap">
                          ₹{rec.rateApplied}/km
                        </td>
              ...
              {selectedGroup.records.length === 0 && (
                <div className="py-20 text-center text-gray-500 italic font-medium">No individual logs available.</div>
              )}
            </div>
