...
//     switch (status) {
//       case "Accepted": return <span className="px-2 py-1 bg-blue-100 text-green-700 rounded-full text-[10px] font-bold uppercase tracking-wider">Accepted</span>;
...
//         <div>
//           <h1 className="text-2xl font-black text-slate-700 tracking-tight">Document Verification</h1>
...
//           <input
//             type="text"
//             className="block w-full pl-10 pr-3 py-2.5 bg-white border border-gray-200 rounded-lg text-sm text-slate-700 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 shadow-sm transition-all placeholder:text-slate-500"
...
//         <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 flex items-center justify-between">
//           <div>
//             <p className="text-xs font-bold text-slate-500 uppercase tracking-widest">Verified</p>
//             <h3 className="text-3xl font-black text-blue-600 mt-1">{documents.filter(d => d.docReviewStatus === 'Accepted').length}</h3>
//           </div>
//           <div className="w-12 h-12 bg-green-50 rounded-full flex items-center justify-center text-blue-600">
//             <FaCheckCircle size={20} />
//           </div>
//         </div>
//         <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 flex items-center justify-between">
//           <div>
//             <p className="text-xs font-bold text-slate-500 uppercase tracking-widest">Total Uploads</p>
...
//                 <tr key={doc._id} className="hover:bg-white transition-colors group">
...
//                       </div>
//                       <div>
//                         <p className="text-sm font-bold text-slate-700">{doc.firstName} {doc.lastName}</p>
...
//                       <FaBriefcase className="text-slate-500" size={12} />
...
//             {/* Modal Header */}
//             <div className="px-6 py-4 bg-slate-900 text-gray-900 flex justify-between items-center shrink-0">
...
//                   <p className="text-xs text-slate-500">Signed by {selectedDoc.firstName} {selectedDoc.lastName}</p>
//                 </div>
//               </div>
//               <button
...
//                   className="px-4 py-2 border border-slate-300 text-slate-700 rounded-lg text-sm font-bold hover:bg-white transition-colors"
//                 >
//                   Download PDF
//                 </button>
...
//                       disabled={actionLoading}
//                       className="px-6 py-2 bg-blue-600 hover:bg-blue-800 text-gray-900 rounded-lg text-sm font-bold transition-colors shadow-lg hover:shadow-xl"
//                     >
...
const Documents = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4 md:p-6 lg:p-8">
      ...
      <div className="mb-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-gray-700">Document Verification</h1>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="relative w-[130px]">
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-1 pointer-events-none">
              <FaFilter className="text-[8px] text-gray-500" />
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 flex items-center justify-between">
          <div>
            ...
            <h3 className="text-2xl font-black text-blue-600 mt-1">{documents.filter(d => d.docReviewStatus === 'Accepted').length}</h3>
          </div>
          <div className="w-10 h-10 bg-green-50 rounded-full flex items-center justify-center text-blue-600">
            <FaCheckCircle size={16} />
          </div>
        </div>
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 flex items-center justify-between">
          <div>
            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Total Uploads</p>
                ...
                <tr key={doc._id} className="hover:bg-white transition-colors group">
                  <td className="px-4 py-3 text-center">
                    <div className="flex items-center justify-center gap-3">
                      ...
                      <div>
                        <p className="text-xs font-bold text-slate-700">{doc.firstName} {doc.lastName}</p>
                  ...
                  <td className="px-4 py-3 text-center">
                    <div className="flex items-center justify-center gap-2 text-slate-500">
                      <FaBriefcase className="text-slate-500" size={10} />
