    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-purple-50 to-blue-100">
        <div className="text-center">
          <div className="w-12 h-12 mx-auto mb-3 border-b-2 border-red-600 rounded-full animate-spin"></div>
  ...
  return (
    <div className="min-h-screen px-2 py-2 bg-gradient-to-br from-purple-50 to-blue-100">
      <div className="mx-auto max-w-9xl">
        {/* ✅ Stats - Simplified to focus on Rejected */}
        ...
        <div className="p-3 mb-3 bg-white rounded-lg shadow-md">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="flex items-center gap-2 pr-4 border-r border-gray-200 mr-2">
                ...
                <h1 className="text-sm font-bold tracking-widest text-gray-800 uppercase">Rejected</h1>
            </div>
                ...
                {currentItems.length > 0 ? (
                  currentItems.map((l) => {
                    ...
                    return (
                      <tr
                        key={l._id}
                        className="transition border-b hover:bg-red-50/30"
                      >
