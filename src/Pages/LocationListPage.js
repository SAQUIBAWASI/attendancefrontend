...
import { FiEdit, FiTrash2, FiCalendar, FiMapPin, FiGlobe, FiActivity, FiChevronUp, FiChevronDown, FiFilter, FiTrash2 as FiTrash2Icon } from "react-icons/fi";
      ...
      <main className="p-2 sm:p-4 lg:p-6">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <div className="relative" ref={cityFilterRef}>
              ...
              >
                ...
                <span className="truncate max-w-[80px]">{filterCity || "City"}</span>
                <span className="text-gray-400 text-[10px]">▾</span>
              </button>
              
              {showCityFilter && (
                <div className="fixed bg-white border border-gray-200 rounded-lg shadow-2xl min-w-[180px] max-h-60 overflow-y-auto"
                  style={{
                    zIndex: 99999,
                    top: cityFilterRef.current ? cityFilterRef.current.getBoundingClientRect().bottom + 4 : 'auto',
                    left: cityFilterRef.current ? cityFilterRef.current.getBoundingClientRect().left : 'auto',
                  }}
                >
                  <div 
                    onClick={() => {
                  ...
                  {uniqueCities.map(city => (
                    <div 
                      ...
                      className={`px-3 py-2 text-xs cursor-pointer hover:bg-blue-50 ${
                        filterCity === city ? 'bg-blue-50 text-blue-700 font-semibold' : 'text-gray-700'
                      }`}
                    >
                      {city}
                    </div>
            ...
            <div className="relative" ref={stateFilterRef}>
              ...
              >
                ...
                <span className="truncate max-w-[80px]">{filterState || "State"}</span>
                <span className="text-gray-400 text-[10px]">▾</span>
              </button>
              ...
              {showStateFilter && (
                <div className="fixed bg-white border border-gray-200 rounded-lg shadow-2xl min-w-[180px] max-h-60 overflow-y-auto"
                  style={{
                    zIndex: 99999,
                    top: stateFilterRef.current ? stateFilterRef.current.getBoundingClientRect().bottom + 4 : 'auto',
                    left: stateFilterRef.current ? stateFilterRef.current.getBoundingClientRect().left : 'auto',
                  }}
                >
                  <div 
                    onClick={() => {
                  ...
                  {uniqueStates.map(state => (
                    <div 
                      ...
                      className={`px-3 py-2 text-xs cursor-pointer hover:bg-blue-50 ${
                        filterState === state ? 'bg-blue-50 text-blue-700 font-semibold' : 'text-gray-700'
                      }`}
                    >
                      {state}
                    </div>
            ...
            <div className="relative">
              <input
                ...
                className="w-[100px] h-8 px-2 py-1 text-xs border border-gray-300 bg-white text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
                maxLength="6"
              />
            </div>
            ...
            {(searchTerm || filterCity || filterState || filterPinCode) && (
              ...
              >
                <FiTrash2Icon className="w-3 h-3" />
                Clear
              </button>
            )}
          </div>
        ...
        <div className="lg:hidden flex items-center justify-between gap-2 flex-wrap mb-3">
          <h1 className="text-base font-bold whitespace-nowrap">
            Location <span className="text-indigo-600">Management</span>
          </h1>
        ...
        <div className="lg:hidden mb-3">
          <div className="flex items-center justify-between p-2.5 bg-white rounded-xl border border-gray-200">
            ...
            <span className="text-xs text-gray-500">
              <strong>{filteredLocations.length}</strong> locations
            </span>
          </div>
              ...
              <div className="pt-3 border-t border-gray-200 space-y-2">
                <div className="grid grid-cols-2 gap-2">
                  ...
                  {(searchTerm || filterCity || filterState || filterPinCode) && (
                    ...
                    >
                      <FiTrash2Icon className="w-4 h-4" />
                      Clear
                    </button>
                  )}
                </div>
