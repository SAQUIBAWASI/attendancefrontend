...
//                                         {/* <span className="text-[10px] text-gray-500 flex items-center justify-center gap-1"><FaEnvelope /> {c.email}</span> */}
//                                     </div>
//                                 </td>
//                                 <td className="px-2 py-2 font-medium text-center">
//                                     <span className="bg-gray-100 text-gray-500 text-[10px] px-2 py-0.5 rounded uppercase ">
//                                         {c.jobId?.role || "N/A"}
//                                     </span>
//                                 </td>
//                                 <td className="px-2 py-2 font-medium text-center">
...
//                                                 <div className="text-[8px] text-gray-500 italic truncate max-w-[80px] mx-auto mt-0.5" title={c.candidateInterviewNote}>
//                                                     "{c.candidateInterviewNote}"
//                                                 </div>
//                                             )}
//                                         </div>
...
//                                 Candidate: <span className="font-semibold text-gray-700">{selectedCandidate?.firstName} {selectedCandidate?.lastName}</span>
//                             </p>
...
//                                 <button
//                                     className="px-6 py-2 text-slate-500 font-bold text-xs uppercase tracking-widest hover:bg-gray-100 rounded"
...
//                             {/* Clean Stats Line */}
//                             <div className="flex items-center gap-6  border-t border-gray-200/50">
//                                 <div className="flex items-center gap-2">
//                                     <span className="text-xs font-semibold text-gray-500">Final Score:</span>
//                                     <span className="text-sm font-black text-indigo-600">
//                                         {selectedAssessmentData.score}<span className="text-xs text-gray-500 font-bold">/100</span>
//                                     </span>
//                                 </div>
...
//                                                     <p className="text-sm font-bold text-gray-700 leading-relaxed">{ans.questionText}</p>
//                                                 </div>
...
//                                                     let optStyle = "bg-white border-gray-200 text-gray-500";
...
//                                     </div>
//                                     <p className="text-gray-700 font-bold mb-1">No detailed analysis available</p>
//                                     <p className="text-gray-500 text-[10px] font-black uppercase tracking-widest max-w-xs">Old assessment record without question tracking</p>
//                                 </div>
//                             )}
//                         </div>
                                    ...
                                    <tr key={c._id} className="border-b hover:bg-white transition-colors">
                                        ...
                                        <td className="px-2 py-2 font-medium text-center">
                                            {c.appliedAt && c.offerSentAt ? (
                                                ...
                                                <span className="text-gray-500 text-[10px] font-black italic uppercase tracking-widest">
                                    ...
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <div className="flex items-center gap-4 ml-auto">
                                            <div className="flex flex-col items-end">
                                                <span className="text-[10px] font-bold text-gray-500 uppercase tracking-tight">Score</span>
                                                <span className="text-sm font-black text-indigo-600">{result.score}/100</span>
                                            </div>
                                            <div className="h-8 w-[1px] bg-gray-200"></div>
                                            <div className="flex flex-col items-end">
                                                <span className="text-[10px] font-bold text-gray-500 uppercase tracking-tight">Date</span>
                                                <span className="text-sm font-black text-gray-500">{new Date(result.completedAt || Date.now()).toLocaleDateString()}</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        {result.answers && result.answers.length > 0 ? (
                                            ...
                                            <div className="text-center py-10 bg-white rounded-xl border border-dashed border-gray-200 flex flex-col items-center justify-center">
                                                <p className="text-gray-500 text-[10px] font-black uppercase tracking-widest">No detailed analysis for this test</p>
                                            </div>
                                        )}
                                    </div>
