{activeTab === "personal-documents" && (
                    <div className="w-full px-6 py-8">
                        ...
                        <div className="w-full bg-[#0a0a0a] rounded-xl border border-[#1f2937]/70 shadow-sm overflow-hidden mb-8">
                            <table className="w-full text-left hidden md:table">
                                <thead className="bg-[#000000] border-b border-[#1f2937]">
                                ...
                                <tbody className="divide-y divide-[#1f2937]">
                                    {[
                                        ...
                                        return (
                                            <tr key={doc.key} className="hover:bg-[#000000] transition align-middle">
                                                ...
                                                <td className="px-6 py-4">
                                                    <span className={`inline-flex px-2.5 py-1 text-xs font-medium rounded-md ${
                                                        uploaded ? "bg-emerald-50 text-emerald-600" : "bg-[#111111] text-gray-500"
                                                    }`}>
                                                    ...
                                                    <div className="flex gap-2">
                                                        <label className={`px-3 py-1.5 text-xs font-medium rounded-md cursor-pointer transition ${
                                                            uploadingPersonalDoc[doc.key] 
                                                                ...
                                                                : "bg-[#111111] hover:bg-[#1f2937] text-gray-300"
                                                        }`}>
                                                        ...
                                                        <button onClick={() => uploaded && window.open(`${API_BASE_URL.replace("/api", "")}/${documentData.filePath}`, "_blank")} disabled={!uploaded} className={`px-3.5 py-1.5 text-xs font-medium rounded-md transition ${uploaded ? "bg-indigo-600 hover:bg-indigo-700 text-white" : "bg-[#111111] text-gray-400 cursor-not-allowed"}`}>
                                                            View
                                                        </button>
                                                    </div>
                                                </td>
                        ...
                        <div className="mt-10 pt-10 border-t border-[#1f2937]">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h3 className="text-xl font-bold text-gray-200">Bank Details</h3>
                            </div>
                            
                            <div className="bg-[#0a0a0a] rounded-2xl border border-[#1f2937] p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                                <div className="flex items-center justify-between mb-6 pb-6 border-b border-[#1f2937]">
                                    <div>
                                        <h4 className="text-base font-bold text-gray-200">Bank Account Information</h4>
                                ...
                                {editingBankDetails ? (
                                    <div className="space-y-5">
                                        <div>
                                            <label className="block text-xs font-bold text-gray-300 mb-2 uppercase tracking-wide">Bank Name</label>
                                            <input
                                                type="text"
                                                placeholder="e.g., ICICI Bank, HDFC Bank"
                                                value={bankDetails.bankName}
                                                onChange={(e) => setBankDetails({ ...bankDetails, bankName: e.target.value })}
                                                className="w-full px-4 py-3 border border-[#374151] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition shadow-sm"
                                            />
                                        </div>
                                        <div>
                                            <label className="block text-xs font-bold text-gray-300 mb-2 uppercase tracking-wide">Account Number</label>
                                            <input
                                                type="text"
                                        ...
                                        <div>
                                            <label className="block text-xs font-bold text-gray-300 mb-2 uppercase tracking-wide">IFSC Code</label>
                                            <input
                                                type="text"
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                                        <div className="bg-gradient-to-br from-[#000000] to-blue-100 p-5 rounded-xl border border-blue-200/50 hover:shadow-md transition-shadow">
                                            <p className="text-xs font-bold text-blue-600 mb-2 uppercase tracking-wide">Bank Name</p>
                                            <p className="text-lg font-bold text-gray-200">{bankDetails.bankName || "—"}</p>
                                        </div>
                                        <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-5 rounded-xl border border-purple-200/50 hover:shadow-md transition-shadow">
                                            ...
                                            <p className="text-lg font-bold text-gray-200 font-mono tracking-widest">{bankDetails.accountNumber ? "****" + bankDetails.accountNumber.slice(-4) : "—"}</p>
                                        </div>
                                        <div className="bg-gradient-to-br from-amber-50 to-amber-100 p-5 rounded-xl border border-amber-200/50 hover:shadow-md transition-shadow">
                                            ...
                                            <p className="text-lg font-bold text-gray-200 font-mono">{bankDetails.ifscCode || "—"}</p>
                                        </div>
                                    </div>
                                )}
                            </div>
                        ...
                        <div className="mt-10 pt-10 border-t border-[#1f2937]">
                            <div className="flex items-center gap-3 mb-6">
                                ...
                                <h3 className="text-xl font-bold text-gray-200">Emergency Contacts</h3>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="bg-[#0a0a0a] rounded-2xl border border-[#1f2937] p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                                    <div className="flex items-center justify-between mb-6 pb-6 border-b border-[#1f2937]">
                                        <div>
                                            <h4 className="text-base font-bold text-gray-200">Primary Contact</h4>
                                    ...
                                    {editingContact1 ? (
                                        <div className="space-y-5">
                                            <div>
                                                <label className="block text-xs font-bold text-gray-300 mb-2 uppercase tracking-wide">Full Name</label>
                                                <input
                                                    type="text"
                                                    placeholder="Enter full name"
                                                    value={emergencyContact1.name}
                                                    onChange={(e) => setEmergencyContact1({ ...emergencyContact1, name: e.target.value })}
                                                    className="w-full px-4 py-3 border border-[#374151] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition shadow-sm"
                                                />
                                            </div>
                                            <div>
                                                <label className="block text-xs font-bold text-gray-300 mb-2 uppercase tracking-wide">Phone Number</label>
                                                <input
                                                    type="tel"
                                            ...
                                            <div>
                                                <label className="block text-xs font-bold text-gray-300 mb-2 uppercase tracking-wide">Relationship</label>
                                                <input
                                                    type="text"
                                        ...
                                        <div className="space-y-4">
                                            <div className="bg-gradient-to-br from-red-50 to-red-100 p-5 rounded-xl border border-red-200/50 hover:shadow-md transition-shadow">
                                                ...
                                                <p className="text-lg font-bold text-gray-200">{emergencyContact1.name || "—"}</p>
                                            </div>
                                            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-5 rounded-xl border border-orange-200/50 hover:shadow-md transition-shadow">
                                                ...
                                                <p className="text-lg font-bold text-gray-200 font-mono">{emergencyContact1.phone || "—"}</p>
                                            </div>
                                            <div className="bg-gradient-to-br from-pink-50 to-pink-100 p-5 rounded-xl border border-pink-200/50 hover:shadow-md transition-shadow">
                                                ...
                                                <p className="text-lg font-bold text-gray-200">{emergencyContact1.relationship || "—"}</p>
                                            </div>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="bg-[#0a0a0a] rounded-2xl border border-[#1f2937] p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                                    <div className="flex items-center justify-between mb-6 pb-6 border-b border-[#1f2937]">
                                        <div>
                                            <h4 className="text-base font-bold text-gray-200">Secondary Contact</h4>
                                    ...
                                    {editingContact2 ? (
                                        ...
                                        <div className="space-y-4">
                                            <div className="bg-gradient-to-br from-red-50 to-red-100 p-5 rounded-xl border border-red-200/50 hover:shadow-md transition-shadow">
                                                <p className="text-xs font-bold text-red-600 mb-2 uppercase tracking-wide">Name</p>
                                                <p className="text-lg font-bold text-gray-200">{emergencyContact2.name || "—"}</p>
                                            </div>
                                            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-5 rounded-xl border border-orange-200/50 hover:shadow-md transition-shadow">
                                                <p className="text-xs font-bold text-orange-600 mb-2 uppercase tracking-wide">Phone</p>
                                                <p className="text-lg font-bold text-gray-200 font-mono">{emergencyContact2.phone || "—"}</p>
                                            </div>
                                            <div className="bg-gradient-to-br from-pink-50 to-pink-100 p-5 rounded-xl border border-pink-200/50 hover:shadow-md transition-shadow">
                                                <p className="text-xs font-bold text-pink-600 mb-2 uppercase tracking-wide">Relationship</p>
                                                <p className="text-lg font-bold text-gray-200">{emergencyContact2.relationship || "—"}</p>
                                            </div>
                                        </div>
                                    )}
                                </div>
