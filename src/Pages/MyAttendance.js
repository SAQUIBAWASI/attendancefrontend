...
import { useEffect, useRef, useState } from "react";
import { FaCalendarAlt, FaClock, FaCheckSquare, FaSquare, FaTrash, FaTimes } from "react-icons/fa";
import { FiCheckCircle, FiCheckSquare, FiFileText, FiMapPin, FiClock, FiCoffee, FiFilter } from "react-icons/fi";
import { useNavigate } from "react-router-dom";
import { API_BASE_URL } from "../config";
import "./EmployeeDashboard.css";
import "./EmployeeLeaves.css";
        ...
        <div className="emp-dash__header">
          <div>
            ...
            <p className="emp-dash__subtitle">
              View your attendance history, break time, and OT claims.
            </p>
          </div>
        </div>
        ...
        <div className="emp-dash__card mb-6">
          <div className="emp-dash__card-header flex-col sm:flex-row gap-3">
            <div>
              ...
              <p className="emp-dash__card-desc">Search and filter your attendance records by date, status, and location.</p>
            </div>
          </div>
