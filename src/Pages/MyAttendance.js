...
import { FaCalendarAlt, FaClock, FaCheckSquare, FaSquare, FaTrash, FaTimes, FaSearch, FaChevronDown, FaChevronUp } from "react-icons/fa";
import { FiCheckCircle, FiCheckSquare, FiFileText, FiMapPin, FiClock, FiCoffee, FiFilter, FiDownload, FiTrash2 } from "react-icons/fi";
  ...
  useEffect(() => {
    ...
    if (searchTerm.trim()) {
      ...
      filtered = filtered.filter(rec => {
        ...
        return recordDate.includes(term) || reason.includes(term);
      });
    }
    ...
    setCurrentPage(1);
  }, [searchTerm, searchDate, dateFrom, dateTo, selectedMonth, statusFilter, onsiteFilter, records]);
      ...
      <main className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="hidden sm:flex items-center justify-between gap-4 flex-wrap mb-4">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {(searchTerm || searchDate || dateFrom || dateTo || selectedMonth || statusFilter !== "all" || onsiteFilter !== "all") && (
              <button
            ...
            <div className="mt-2 p-4 bg-white rounded-xl border border-gray-200 space-y-3">
              ...
              <div className="pt-3 border-t border-gray-200 space-y-2">
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <button
                    onClick={downloadCSV}
                    className="flex items-center justify-center gap-1.5 px-3 py-2.5 text-sm font-semibold text-white bg-green-600 rounded-lg hover:bg-green-700 transition-all shadow-md"
                  >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-6 gap-3 md:gap-4 mb-6">
          ...
          <div className="emp-dash__stat">
            ...
            <div className="emp-dash__stat-meta">8h+ days</div>
          </div>
          ...
          <div className="emp-dash__stat">
            ...
            <div className="emp-dash__stat-meta">records claimed</div>
          </div>
        </div>
        ...
        <div className="emp-dash__card">
          <div className="emp-dash__card-header">
            <div>
              ...
              <p className="emp-dash__card-desc">Your daily check-in/out history with OT tracking.</p>
            </div>
          </div>
                ...
                <table className="emp-dash__table">
                  <thead>
                    <tr>
                      ...
                      <th style={{ textAlign: "center" }}>Claimed OT</th>
                  ...
                  <tbody>
                    {currentRecords.map((rec, idx) => {
                      ...
                      if (totalHours >= assignedShift) hoursBadgeClass = 'text-emerald-700 bg-emerald-50 border-emerald-100';
                      else if (totalHours >= assignedShift * 0.5) hoursBadgeClass = 'text-amber-700 bg-amber-50 border-amber-100';
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-3 py-3 text-center whitespace-nowrap">
                            <span className="px-2 py-0.5 text-[10px] font-bold text-purple-600 bg-purple-50 rounded border border-purple-100">
                              {assignedShift}h
                            </span>
                          </td>
                          <td className="px-3 py-3 text-center whitespace-nowrap">
                          ...
                          <td className="px-3 py-3 text-center whitespace-nowrap">
                            {hasOT ? (
                              <span className="px-2 py-0.5 text-[10px] font-bold text-orange-600 bg-orange-50 rounded border border-orange-200">
                          ...
                          <td className="px-3 py-3 text-center whitespace-nowrap">
                            {claimed ? (
                              <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-bold border ${statusColor} ${bgColor} ${borderColor}`}>
                                {statusDisplay}
                              </span>
                            ) : (
                              <span className="text-xs text-slate-300">-</span>
                          ...
                          <td className="px-3 py-3 text-center whitespace-nowrap">
                            <span className="text-slate-600 bg-slate-50 px-2 py-0.5 rounded max-w-[100px] truncate block text-[11px]">
                              {rec.reason || "-"}
                            </span>
                          </td>
