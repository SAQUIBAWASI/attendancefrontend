            ...
            <div className="overflow-x-auto">
              <table className="min-w-full">
                <thead className="bg-gradient-to-r from-green-500 to-blue-600">
                  <tr>
                    <th className="py-2 text-center text-white">Employee ID</th>
                    <th className="py-2 text-center text-white">Name</th>
                    <th className="py-2 text-center text-white">Department</th>
                    <th className="py-2 text-center text-white">Designation</th>
                    <th className="py-2 text-center text-white">Check In</th>
                    <th className="py-2 text-center text-white">Check Out</th>
                    <th className="py-2 text-center text-white">Total Hours</th>
...
//             designation: employee?.designation || employee?.role || "N/A",
//             joinDate: employee?.joinDate,
//             employeeImage: employee?.image || employee?.profileImage
//           };
//         })
//         .filter(rec => rec !== null); // Remove hidden employees
