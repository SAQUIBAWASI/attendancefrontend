      ...
      <div className="max-w-9xl mx-auto animate-in fade-in duration-700">
        ...
        <div className="flex flex-col gap-4 mb-6 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex-shrink-0">
            <h2 className="text-2xl font-bold text-gray-300 tracking-tight">Open Opportunities</h2>
          ...
          <div className="flex flex-wrap items-center justify-start xl:justify-end gap-3 w-full xl:w-auto">
            ...
            <div className="relative w-full sm:w-64" ref={roleDropdownRef}>
              ...
              <div
                className="w-full bg-[#0a0a0a] py-2.5 pl-10 pr-10 text-xs text-gray-300 border border-[#1f2937] rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 font-bold transition-all hover:bg-[#000000] cursor-pointer shadow-sm relative overflow-hidden text-ellipsis whitespace-nowrap"
                ...
                <div className="absolute z-[110] w-full mt-2 bg-[#0a0a0a] border border-[#1f2937] rounded-2xl shadow-2xl overflow-hidden animate-in fade-in slide-in-from-top-2 duration-300">
                  <div className="p-3 border-b border-gray-50 bg-[#000000]/50">
                    <div className="relative">
                      ...
                      <input
                        type="text"
                        className="w-full py-2 pl-8 pr-4 text-[10px] bg-[#0a0a0a] border border-[#1f2937] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 font-bold"
            ...
            {(localSearchQuery || roleFilter) && (
              <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 text-xs font-bold text-gray-500 bg-[#0a0a0a] border border-[#1f2937] hover:bg-[#000000] rounded-xl transition-all shadow-sm uppercase tracking-widest"
              >
            ...
            <div className="bg-[#0a0a0a] px-4 py-2.5 rounded-xl border border-[#1f2937] shadow-sm flex items-center gap-2">
              ...
              <span className="text-xs font-semibold text-gray-400 uppercase tracking-wider">{filteredJobs.length} Jobs Live</span>
            </div>
          </div>
        </div>
          ...
          <div className="overflow-x-auto">
            {filteredJobs.length > 0 ? (
                ...
                <tbody className="divide-y divide-[#1f2937] text-center">
                  {filteredJobs.map((job) => (
                    <tr key={job._id} className="group hover:bg-indigo-50/20 transition-all duration-300">
                      <td className="py-3 px-8 text-sm font-bold text-gray-300 leading-tight uppercase tracking-tight">
                        {job.role}
                        {job.jobType && (
                      ...
                      <td className="py-3 px-6 text-xs font-medium text-gray-400">
                        <div className="flex items-center justify-center gap-2">
                          <FaMapMarkerAlt className="text-blue-400" size={12} />
                          {job.location}
                        </div>
                      </td>
                      <td className="py-3 px-6 text-xs font-medium text-gray-400 uppercase tracking-tight">
                        <div className="flex items-center justify-center gap-2">
                          <FaClock className="text-blue-400" size={12} />
                          {job.experience || "Fresher"}
                        </div>
                      </td>
                      <td className="py-3 px-6 text-xs font-bold text-gray-300">
              ...
              <div className="p-24 text-center">
                ...
                <h3 className="text-lg font-bold text-gray-300 uppercase tracking-widest">No Matches Found</h3>
