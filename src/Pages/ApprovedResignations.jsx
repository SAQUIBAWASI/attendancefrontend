    ...
    <div className="p-3 mx-auto bg-white rounded-lg shadow-md max-w-9xl min-h-screen">
      ...
      <div className="flex flex-col gap-4 mb-4 xl:flex-row xl:items-center xl:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold text-gray-700">Approved Resignations</h2>
            <p className="text-xs text-gray-500">{filteredData.length} approved resignation(s)</p>
          </div>
          <span className="px-3 py-1 text-[10px] font-black rounded-full uppercase tracking-widest bg-blue-100 text-green-700">
            Approved
          </span>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-start xl:justify-end gap-3 w-full xl:w-auto">
          ...
          {/* Buttons */}
          <button onClick={exportToCSV} className="flex items-center gap-1 px-3 py-2 text-xs font-medium text-gray-900 bg-blue-600 hover:bg-blue-800 rounded-lg transition-colors shadow-sm">
            ...
            <tbody>
              {filteredData.map((app) => (
                <tr key={app._id} className="border-b hover:bg-white transition-colors">
                  ...
                  <td className="p-4 text-sm font-medium text-center">
                    <span className={`px-2 py-1 rounded-full text-[10px] font-bold bg-blue-100 text-green-700`}>
