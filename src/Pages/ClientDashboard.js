      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
        ...
        <div className="relative max-w-6xl px-4 py-12 mx-auto">
          ...
          >
            ...
            <p className="text-gray-500">Select a product to access your dashboard</p>
          </motion.div>
          ...
          >
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-gray-700">{clientData.clientId}</p>
              </div>
              <div className="text-center">
                <p className="text-xs text-gray-500">Email</p>
                <p className="text-sm font-medium text-gray-700">{clientData.email}</p>
              </div>
              <div className="text-center">
                <p className="text-xs text-gray-500">Company</p>
                <p className="text-sm font-medium text-gray-700">{clientData.companyName}</p>
              </div>
              <div className="text-center">
                <p className="text-xs text-gray-500">Location</p>
                <p className="text-sm font-medium text-gray-700">{clientData.location}</p>
              </div>
            </div>
          </motion.div>
    ...
    <div className="relative flex items-center justify-center min-h-screen px-4 py-6 overflow-hidden bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100">
      ...
      >
        ...
        <div className="flex flex-col justify-center p-6 md:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <motion.button
              ...
              type="submit"
              disabled={isLoading}
              className={`w-full py-2.5 text-gray-900 text-sm font-medium rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 hover:from-purple-600 hover:to-blue-600 transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center ${
        ...
        <motion.div 
          ...
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.5, delay: 0.3 }}
          className="flex flex-col items-center justify-center p-6 text-gray-900 bg-gradient-to-br from-blue-600 to-purple-600 md:p-8"
        >
          <motion.img
            initial={{ scale: 0.9 }}
            animate={{ scale: 1 }}
...
//           <h1 className="mb-1 text-2xl font-bold text-gray-700 sm:text-3xl md:text-4xl">
//             Your <span className="text-transparent bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text">Purchased Products</span>
//           </h1>
//           <p className="text-xs text-gray-500 sm:text-sm">Select a product to access your dashboard</p>
//         </motion.div>
...
//                 <p className="text-[8px] text-gray-500 mt-0.5 sm:text-[10px] sm:mt-1">
//                   Click to access
//                 </p>
