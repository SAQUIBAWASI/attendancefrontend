        ...
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-200 mb-6">
          <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                <h2 className="text-2xl font-bold text-gray-700 tracking-tight">Offer Letters & Documents</h2>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="relative w-full sm:w-52" ref={typeDropdownRef}>
                ...
                >
                  ...
                  <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className={`text-gray-500 transition-transform duration-200 ${isTypeDropdownOpen ? 'rotate-180' : ''}`}><path d="m6 9 6 6 6-6" /></svg>
                </div>
                {isTypeDropdownOpen && (
                      ...
                      <td className="py-2 px-8">
                        <div className="flex items-center justify-center gap-3">
                          ...
                          <div className="text-left">
                            ...
                            <div className="text-[10px] text-gray-500 uppercase tracking-widest mt-0.5 font-medium">Formal Documentation</div>
                          </div>
                        </div>
                      </td>
            ...
            <form onSubmit={handleSubmitResignation} className="p-8">
              <div className="mb-6">
                <p className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-4">
                  Submitting resignation for: <span className="text-gray-700">{canResignApp?.jobId?.role || canResignApp?.role || "N/A"}</span>
                </p>
