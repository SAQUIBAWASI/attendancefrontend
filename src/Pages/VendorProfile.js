                ...
                <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-white'}>
                  <td className="py-3 px-4 border border-gray-200">
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="font-semibold text-gray-700">{feedback.userId?.name || 'Anonymous'}</div>
                    ...
                    <div className="flex items-center">
                      <div className="flex mr-2">
                        {[...Array(5)].map((_, i) => (
                          <svg
                            key={i}
                            className={`w-5 h-5 ${i < feedback.stars ? 'text-yellow-400' : 'text-gray-700'}`}
                            fill="currentColor"
                            viewBox="0 0 20 20"
                          >
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            <h2 className="text-xl font-bold text-gray-700">Coupon Redemption Statistics</h2>
  ...
  const renderPaymentsSection = () => {
    ...
    return (
      <div className="space-y-8">
        {/* Payment Statistics */}
        <div className="bg-white p-6 rounded-lg border border-gray-200">
          <h2 className="text-xl font-bold text-gray-700 mb-6">Payment Overview</h2>
