...
//           className="emp-dash__btn-outline mt-3"
//         >
//           Clear All Filters
//         </button>
//       )}
...
const AdminIssueManagement = () => {
  ...
  // This effect runs whenever filters or issues change
  useEffect(() => {
    applyFiltersAndSort();
  }, [issues, filters, sortConfig]);
  ...
  const handleStatClick = (filterType, filterValue) => {
    ...
    // Force apply filters after state update
    setTimeout(() => {
      applyFiltersAndSort();
    }, 100);
  };
  ...
  <h1 className="emp-dash__greeting text-lg sm:text-xl font-bold whitespace-nowrap flex items-center gap-2">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 md:gap-4 mb-6">
          ...
          <div 
            ...
            className={`emp-dash__stat cursor-pointer transition-all hover:scale-105 hover:shadow-lg ${
              activeFilter === 'Open' ? 'ring-2 ring-blue-500 ring-offset-2' : ''
            }`}
          >
            <div className="emp-dash__stat-top">
              <span className="emp-dash__stat-label">Open</span>
          ...
          <div 
            ...
            className={`emp-dash__stat cursor-pointer transition-all hover:scale-105 hover:shadow-lg ${
              activeFilter === 'In Progress' ? 'ring-2 ring-blue-500 ring-offset-2' : ''
            }`}
          >
            <div className="emp-dash__stat-top">
              <span className="emp-dash__stat-label">In Progress</span>
          ...
          <div 
            ...
            className={`emp-dash__stat cursor-pointer transition-all hover:scale-105 hover:shadow-lg ${
              activeFilter === 'Resolved' ? 'ring-2 ring-blue-500 ring-offset-2' : ''
            }`}
          >
            <div className="emp-dash__stat-top">
              <span className="emp-dash__stat-label">Resolved</span>
          ...
          <div 
            onClick={() => handleStatClick('status', 'Closed')}
            className={`emp-dash__stat col-span-2 lg:col-span-1 cursor-pointer transition-all hover:scale-105 hover:shadow-lg ${
              activeFilter === 'Closed' ? 'ring-2 ring-blue-500 ring-offset-2' : ''
            }`}
          >
            <div className="emp-dash__stat-top">
              <span className="emp-dash__stat-label">Closed</span>
  ...
  <div className={`${showMobileFilters ? 'block' : 'hidden sm:block'}`}>
    <div className="emp-dash__card-body p-4 bg-gray-50/50">
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-3">
        <div className="text-left">
          ...
          <div className="relative">
            ...
            <input
              ...
              value={filters.searchTerm}
              onChange={(e) => handleFilterChange('searchTerm', e.target.value)}
              className="w-full pl-8 pr-3 py-2 text-xs border border-gray-300 bg-white text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
              placeholder="Search issues..."
            />
          </div>
        </div>
        ...
        <div className="text-left">
          <label className="block mb-1 text-xs font-medium text-gray-600">Employee ID</label>
          <input
            type="text"
            value={filters.employeeId}
            onChange={(e) => handleFilterChange('employeeId', e.target.value)}
        ...
        <div className="text-left">
          <label className="block mb-1 text-xs font-medium text-gray-600">Priority</label>
          <select
            value={filters.priority}
            onChange={(e) => handleFilterChange('priority', e.target.value)}
        ...
        <div className="text-left">
          <label className="block mb-1 text-xs font-medium text-gray-600">Status</label>
          <select
            value={filters.status}
            onChange={(e) => handleFilterChange('status', e.target.value)}
            className="w-full h-9 px-3 text-xs border border-gray-300 bg-white text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
        ...
        <div className="text-left">
          <label className="block mb-1 text-xs font-medium text-gray-600">Issue Type</label>
          <select
            value={filters.issueType}
            onChange={(e) => handleFilterChange('issueType', e.target.value)}
            className="w-full h-9 px-3 text-xs border border-gray-300 bg-white text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
      ...
      {(getActiveFilterCount() > 0 || activeFilter) && (
        <div className="flex flex-wrap items-center gap-2 mt-3 pt-3 border-t border-gray-100">
          ...
          {filters.employeeId && (
            <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-indigo-50 text-indigo-700 rounded-full text-[9px] font-semibold border border-indigo-200">
              Employee: {filters.employeeId}
              <button onClick={() => handleFilterChange('employeeId', '')} className="hover:text-indigo-900 ml-0.5">
                <FaTimes size={8} />
              </button>
            </span>
          )}
          {filters.priority && (
            <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-blue-50 text-blue-700 rounded-full text-[9px] font-semibold border border-blue-200">
              Priority: {filters.priority}
              <button onClick={() => handleFilterChange('priority', '')} className="hover:text-blue-900 ml-0.5">
                <FaTimes size={8} />
              </button>
            </span>
          )}
          {filters.status && (
            <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-green-50 text-green-700 rounded-full text-[9px] font-semibold border border-green-200">
              Status: {filters.status}
              <button onClick={() => handleFilterChange('status', '')} className="hover:text-green-900 ml-0.5">
                <FaTimes size={8} />
              </button>
            </span>
          )}
          {filters.issueType && (
            <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-purple-50 text-purple-700 rounded-full text-[9px] font-semibold border border-purple-200">
              Type: {filters.issueType}
              <button onClick={() => handleFilterChange('issueType', '')} className="hover:text-purple-900 ml-0.5">
                <FaTimes size={8} />
              </button>
            </span>
          )}
          {filters.searchTerm && (
            <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-gray-100 text-gray-700 rounded-full text-[9px] font-semibold border border-gray-200">
              Search: {filters.searchTerm}
              <button onClick={() => handleFilterChange('searchTerm', '')} className="hover:text-gray-900 ml-0.5">
                <FaTimes size={8} />
              </button>
            </span>
          )}
            ...
            <>
              ...
              <div className="overflow-x-auto">
                <table className="emp-dash__table min-w-[900px]">
                  <thead>
                    <tr>
                      <th onClick={() => handleSort('issueTitle')} className="cursor-pointer hover:bg-gray-200 whitespace-nowrap">
                        Issue {getSortIcon('issueTitle')}
                      </th>
                      <th onClick={() => handleSort('employeeId')} className="cursor-pointer hover:bg-gray-200 whitespace-nowrap">
                        Employee {getSortIcon('employeeId')}
                      </th>
                      <th onClick={() => handleSort('issueType')} className="cursor-pointer hover:bg-gray-200 whitespace-nowrap">
                        Type {getSortIcon('issueType')}
                      </th>
                      <th onClick={() => handleSort('priority')} className="cursor-pointer hover:bg-gray-200 whitespace-nowrap">
                        Priority {getSortIcon('priority')}
                      </th>
                      <th onClick={() => handleSort('status')} className="cursor-pointer hover:bg-gray-200 whitespace-nowrap">
                        Status {getSortIcon('status')}
                      </th>
                      <th onClick={() => handleSort('createdAt')} className="cursor-pointer hover:bg-gray-200 whitespace-nowrap">
                        Date {getSortIcon('createdAt')}
                      </th>
                  ...
                  <tbody>
                    {filteredIssues.map((issue) => (
                      <tr key={issue._id}>
                        <td>
                          <div className="flex flex-col">
                            <span className="font-semibold text-gray-800 text-xs">{issue.issueTitle}</span>
                        ...
                        <td>
                          <div className="flex flex-col">
                            <span className="font-medium text-gray-800 text-xs">{issue.employeeId || 'N/A'}</span>
                            <span className="text-[10px] text-gray-500">{issue.employeeName || ''}</span>
                          </div>
                        </td>
                        <td>
                          <span className="px-2 py-0.5 bg-gray-100 text-gray-700 rounded-full text-[10px] font-medium border border-gray-200 whitespace-nowrap">
                            {issue.issueType}
                          </span>
                        </td>
                        <td>
                          <span className={`px-2 py-0.5 rounded-full text-[10px] font-medium border whitespace-nowrap ${getPriorityColor(issue.priority)}`}>
                            {issue.priority}
                          </span>
                        </td>
                        <td>
