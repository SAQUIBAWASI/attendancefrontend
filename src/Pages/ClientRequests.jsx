...
//         <div className="p-6">
//             <div className="mb-6">
//                 <h1 className="text-2xl font-bold text-gray-700">Pending Client Requests</h1>
//                 <p className="text-gray-500">Review and manage client registration requests</p>
//             </div>
...
//                     <thead>
//                         <tr>
//                             <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
//                                 Date
//                             </th>
//                             <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
//                                 Client Details
...
//                                 Location
//                             </th>
//                             <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-center text-xs font-semibold text-gray-500 uppercase tracking-wider">
//                                 Actions
//                             </th>
//                         </tr>
//                     </thead>
...
//                                                 <span className="font-medium text-gray-700">{req.country}</span>
//                                             </div>
