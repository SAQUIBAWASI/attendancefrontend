...
const InfoItem = ({ label, value }) => (
    <div className="flex flex-col">
        <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest leading-relaxed">{label}</p>
        <p className="text-sm font-bold text-gray-700 tracking-tight">{value || "N/A"}</p>
    </div>
);
...
const renderMarkdown = (text) => {
    if (!text) return "";
    let html = text
        .replace(/^# (.*$)/gm, '<h1 class="text-2xl font-black mb-6 text-gray-900 border-b-2 border-gray-200 pb-4">$1</h1>')
        .replace(/^## (.*$)/gm, '<h2 class="text-xl font-bold mb-4 text-gray-700 mt-8">$1</h2>')
        ...
        <div className="min-h-screen flex items-center justify-center bg-white">
            <div className="flex flex-col items-center gap-6">
                ...
                <div className="text-center">
                    <p className="text-base font-bold text-gray-700">Drafting Offer...</p>
                </div>
            </div>
        </div>
    );
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4 mb-2 xl:flex-row xl:items-center xl:justify-between px-2">
                    <div className="flex items-center gap-4">
                        <button
                            onClick={() => navigate(-1)}
                            className="flex items-center gap-2 px-3 py-2 text-sm font-bold text-gray-500 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors shadow-sm"
                        >
                    ...
                    {candidate && (
                        <div className="flex items-center gap-4 bg-white px-5 py-3 rounded-2xl border border-gray-200 shadow-sm">
                            ...
                            <div className="flex flex-col">
                                <span className="text-sm font-bold text-gray-700 leading-tight">{candidate.firstName} {candidate.lastName}</span>
                        ...
                        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
                            ...
                            <div className="space-y-4">
                                <div className="flex flex-col gap-1.5">
                                    <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1">Logo Provider URL</label>
                                    <input
                                        type="text"
                                        value={logoUrl}
                        ...
                        <div className="bg-white rounded-2xl border border-gray-200 shadow-lg overflow-hidden flex flex-col min-h-[750px]">
                            ...
                            <div className="flex bg-white/50 p-1.5 gap-1.5 border-b border-gray-200">
                                ...
                                <button
                                    ...
                                    className={`flex-1 py-3 px-4 rounded-xl text-[10px] font-black uppercase tracking-[0.2em] transition-all ${isPreview ? 'bg-white text-blue-600 shadow-sm border border-gray-200' : 'text-gray-500 hover:text-gray-500 hover:bg-gray-100'}`}
                                >
                                    Preview
                                </button>
                            </div>
                            ...
                            <div className="flex-1 p-8 flex flex-col">
                                {isPreview ? (
                                    <div className="flex-1 bg-white border border-gray-200 rounded-xl p-12 overflow-y-auto max-h-[600px] shadow-inner relative animate-in fade-in duration-500">
                                        <div className="flex justify-between items-start mb-16 px-4">
                                            ...
                                            <div className="text-right">
                                                ...
                                                <p className="text-[9px] font-bold text-gray-500 mt-2 uppercase tracking-[0.2em]">Authentic Documentation</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-20 flex justify-between items-end border-t border-gray-200 pt-10 px-4">
                                            <div className="flex flex-col gap-6">
                                                <div className="w-24 h-[1px] bg-gray-300"></div>
                                                <p className="text-[9px] font-black text-gray-500 uppercase tracking-widest">Director - Human Resources</p>
                                            </div>
                                ...
                                <div className="mt-8 flex flex-col md:flex-row justify-between items-center gap-6 pt-8 border-t border-gray-50">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[9px] font-bold text-gray-500 uppercase tracking-widest">Ready for secure dispatch</p>
                                        </div>
                                    </div>
