...
//     <span className="font-bold text-gray-700 text-right">{value || "N/A"}</span>
//   </div>
// );
...
//           {/* <p className="text-gray-500 text-[11px] font-bold mt-1 uppercase tracking-widest pl-0">
...
//                   <div className="max-h-60 overflow-y-auto py-1">
//                     <div
//                       className={`px-4 py-2 text-xs font-bold cursor-pointer hover:bg-indigo-50 transition-colors ${!candidateRoleFilter ? 'text-indigo-600 bg-indigo-50/50' : 'text-gray-500'}`}
...
//                         <div
//                           key={`cand-${r._id}`}
//                           className={`px-4 py-2 text-xs font-bold cursor-pointer hover:bg-indigo-50 transition-colors ${candidateRoleFilter === r.name ? 'text-indigo-600 bg-indigo-50/50' : 'text-gray-500'}`}
...
//             <button onClick={fetchData} className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-500 bg-gray-100 hover:bg-gray-200 hover:text-gray-900 rounded-lg transition-colors shadow-sm">
...
//                           </>
//                         ) : (
//                           <FaTimes className="text-gray-900" size={12} />
//                         )}
//                       </div>
//                     </td>
//                   );
...
//                         </div>
//                         <div>
//                           <div className="text-sm font-bold text-gray-700">{candName}</div>
//                           <div className="text-[10px] text-gray-500 font-medium">{candEmail || candId.slice(-8)}</div>
//                         </div>
//                       </div>
//                     </td>
...
//               {/* Documents Grid */}
//               <div>
//                 <h3 className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-6">Verification Documents</h3>
...
//                     return (
//                       <div key={key} className="bg-white border border-gray-200 rounded-xl p-5 hover:shadow-lg transition-all flex flex-col justify-between min-h-[160px]">
//                         <div>
//                           <div className="flex justify-between items-start mb-3">
//                             <h4 className="text-sm font-bold text-gray-700">{key.replace(/([A-Z])/g, ' $1')}</h4>
//                             <StatusBadge status={state} />
//                           </div>
//                           <p className="text-[10px] text-gray-500 font-mono truncate">{doc.fileName || 'No file selected'}</p>
//                         </div>
...
//                               className={`flex-1 py-1.5 rounded-lg text-[10px] font-bold border transition-all ${state === 'rejected' ? 'bg-red-100 border-red-200 text-red-700' : 'border-gray-200 text-gray-500 hover:text-red-600'}`}
//                             >
//                               Reject
//                             </button>
//                           </div>
...
//               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pt-6 border-t border-gray-200">
...
//                         <div>
//                           <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-1 block">Institution Name</label>
//                           <input
//                             type="text"
...
//                         </div>
//                         <div>
//                           <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-1 block">Account Number</label>
//                           <input
//                             type="text"
//                             className="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-xs font-bold text-gray-700 focus:ring-2 focus:ring-blue-500 outline-none transition-all shadow-sm"
...
//                         </div>
//                         <div>
//                           <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-1 block">IFSC Code</label>
//                           <input
//                             type="text"
//                             className="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-xs font-bold text-gray-700 focus:ring-2 focus:ring-blue-500 outline-none transition-all shadow-sm"
...
//                               });
//                             }}
//                             className="px-3 py-2 bg-gray-100 text-gray-500 rounded-lg text-[10px] font-black uppercase tracking-widest hover:bg-gray-200 transition-all"
//                           >
//                             Cancel
//                           </button>
//                         </div>
...
//                           <p className="text-[10px] font-bold text-gray-500 italic text-center py-2">No bank details provided</p>
//                         )}
//                       </>
//                     )}
//                   </div>
...
//                         </div>
//                         <div>
//                           <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-1 block">Phone Number</label>
//                           <input
//                             type="text"
//                             className="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-xs font-bold text-gray-700 focus:ring-2 focus:ring-rose-500 outline-none transition-all shadow-sm"
...
//                         </div>
//                         <div>
//                           <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-1 block">Relationship</label>
//                           <input
//                             type="text"
//                             className="w-full bg-white border border-gray-200 rounded-lg px-3 py-2 text-xs font-bold text-gray-700 focus:ring-2 focus:ring-rose-500 outline-none transition-all shadow-sm"
...
//                           <p className="text-[10px] font-bold text-gray-500 italic text-center py-2">No contact provided</p>
//                         )}
//                       </>
//                     )}
//                   </div>
...
//                       <p className="text-[10px] font-bold text-gray-500 italic text-center py-2">No academic details provided</p>
//                     )}
//                   </div>
//                 </div>
...
//                     <div className="pt-2">
//                       <span className="text-[10px] font-black text-gray-500 uppercase mb-2 block tracking-widest">Skills</span>
//                       <div className="flex flex-wrap gap-1.5">
//                         {(data.candidateId?.skills || "").split(',').map((skill, idx) => skill.trim() && (
//                           <span key={idx} className="px-2 py-0.5 bg-white border border-gray-200 text-gray-500 rounded-md text-[9px] font-bold">
//                             {skill.trim()}
//                           </span>
//                         ))}
//                         {!data.candidateId?.skills && <span className="text-[10px] text-gray-500 italic font-medium">No skills listed</span>}
//                       </div>
//                     </div>
//                   </div>
//                 </div>
...
//                 <p className="text-[10px] font-black text-gray-500 uppercase tracking-widest border-b border-gray-200 pb-2">Record Hash</p>
//                 <code className="text-[9px] text-blue-600 bg-blue-50 px-2 py-1 rounded block break-all font-mono">{data._id}</code>
//                 <div className="pt-2">
//                   <p className="text-[10px] text-gray-500 uppercase font-black tracking-widest mb-1">Created At</p>
      ...
      <div className="w-full space-y-8 p-4">
        ...
        <div className="w-full pb-12">
          ...
          <div className="w-full space-y-12">
                          ...
                          <tr key={key} className="group hover:bg-white transition-colors">
                            ...
                            <td className="px-6 py-4">
                              <div className="flex items-center justify-end gap-2">
                                ...
                                <button
                                  onClick={() => mark(key, 'rejected')}
                                  className={`px-3 py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-widest border transition-all flex items-center justify-center gap-1.5 ${state === 'rejected' ? 'bg-red-100 border-red-200 text-red-700 shadow-sm' : 'border-gray-200 bg-white text-gray-500 hover:border-red-500 hover:text-red-500'}`}
                                >
            ...
            {/* Extra Details */}
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 pt-12 border-t border-gray-200">
              {/* Bank Details Section */}
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                ...
                <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-200 space-y-4">
                  {isEditingBank ? (
                    <div className="space-y-4">
                      <div>
                        <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1.5 block">Institution Name</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1.5 block">Account Number</label>
                        <input
                          type="text"
                          className="w-full bg-white border border-gray-200 rounded-lg px-4 py-2 text-sm font-bold text-gray-700 focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                          value={bankForm.accountNumber}
                      ...
                      <div>
                        <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1.5 block">IFSC Code</label>
                        <input
                          type="text"
                          className="w-full bg-white border border-gray-200 rounded-lg px-4 py-2 text-sm font-bold text-gray-700 focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                          value={bankForm.ifscCode}
                      ...
                      <div className="flex gap-2 pt-2">
                        ...
                        <button
                          ...
                          className="px-4 h-9 bg-gray-100 text-gray-500 rounded-lg text-[10px] font-bold uppercase tracking-widest hover:bg-gray-200 transition-all"
                        >
                          Cancel
                        </button>
                      </div>
                ...
                <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-200 space-y-4">
                  {isEditingEmergency1 ? (
                    <div className="space-y-4">
                      ...
                      <div>
                        <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-1.5 block">Relationship</label>
                        <input
                          type="text"
                          className="w-full bg-white border border-gray-200 rounded-lg px-4 py-2 text-sm font-bold text-gray-700 focus:ring-2 focus:ring-rose-500 outline-none transition-all"
                          value={emergency1Form.relationship}
