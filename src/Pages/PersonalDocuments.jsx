...
export default function PersonalDocuments() {
  ...
  if (Array.isArray(data)) {
    ...
    return (
      <div className="w-full min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-2 md:p-4 lg:p-6">
        {/* Filters Section */}
        <div className="p-2 mb-3 bg-white rounded-lg shadow-md">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="flex items-center gap-2 ml-auto">
              <button onClick={fetchData} className="h-8 px-3 text-xs font-medium text-gray-600 bg-gray-100 border border-gray-300 rounded-md hover:bg-gray-200 transition flex items-center gap-1">
