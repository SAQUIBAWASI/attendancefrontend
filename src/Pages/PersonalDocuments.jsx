...
//     <span className="font-bold text-gray-300 text-right">{value || "N/A"}</span>
//   </div>
// );
...
//     missing: "bg-[#111111] text-gray-500"
//   };
...
//   if (loading) return (
//     <div className="min-h-screen flex items-center justify-center bg-[#000000]/50">
...
//   if (!data) return (
//     <div className="min-h-screen flex flex-col items-center justify-center bg-[#000000]/50 p-6">
//       <div className="bg-[#0a0a0a] rounded-lg p-8 shadow-md text-center max-w-sm w-full border border-[#1f2937]">
//         <FaUser size={32} className="mx-auto text-gray-300 mb-4" />
//         <h2 className="text-xl font-bold text-gray-300 mb-2">Unavailable</h2>
...
//                   <div className="max-h-60 overflow-y-auto py-1">
//                     <div
//                       className={`px-4 py-2 text-xs font-bold cursor-pointer hover:bg-indigo-50 transition-colors ${!candidateRoleFilter ? 'text-indigo-600 bg-indigo-50/50' : 'text-gray-400'}`}
...
//                         <div
//                           key={`cand-${r._id}`}
//                           className={`px-4 py-2 text-xs font-bold cursor-pointer hover:bg-indigo-50 transition-colors ${candidateRoleFilter === r.name ? 'text-indigo-600 bg-indigo-50/50' : 'text-gray-400'}`}
...
//             <button onClick={fetchData} className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-400 bg-[#111111] hover:bg-[#1f2937] hover:text-gray-200 rounded-lg transition-colors shadow-sm">
...
//                             <button
//                               onClick={() => openFile(doc.filePath)}
//                               className="p-1.5 rounded bg-[#000000] text-gray-500 hover:bg-gray-800 hover:text-white transition-all"
//                               title="Download"
//                             >
//                               <FaDownload size={12} />
//                             </button>
...
//                 return (
//                   <tr key={candId} className="hover:bg-[#000000] transition-colors">
//                     <td className="p-4">
...
//                         </div>
//                         <div>
//                           <div className="text-sm font-bold text-gray-300">{candName}</div>
...
//                     <td className="p-4 text-center">
//                       <div className={`w-2 h-2 mx-auto rounded-full ${docs.bankDetails?.bankName ? 'bg-green-500 shadow-sm' : 'bg-[#111111]'}`}></div>
//                     </td>
...
//                     return (
//                       <div key={key} className="bg-[#0a0a0a] border border-[#1f2937] rounded-xl p-5 hover:shadow-lg transition-all flex flex-col justify-between min-h-[160px]">
//                         <div>
//                           <div className="flex justify-between items-start mb-3">
//                             <h4 className="text-sm font-bold text-gray-300">{key.replace(/([A-Z])/g, ' $1')}</h4>
...
//                               onClick={() => openFile(doc.filePath)}
//                               disabled={!uploaded}
//                               className={`flex-1 py-2 rounded-lg text-xs font-bold flex items-center justify-center gap-2 transition-all ${uploaded ? 'bg-blue-600 text-white hover:bg-blue-700' : 'bg-[#000000] text-gray-300'}`}
//                             >
//                               <FaEye size={12} /> View
//                             </button>
//                             <button
//                               onClick={() => openFile(doc.filePath)}
//                               disabled={!uploaded}
//                               className={`flex-1 py-2 rounded-lg text-xs font-bold border flex items-center justify-center gap-2 transition-all ${uploaded ? 'border-[#1f2937] text-gray-300 hover:bg-[#000000]' : 'bg-[#000000] border-transparent text-gray-300'}`}
//                             >
...
//                               className={`flex-1 py-1.5 rounded-lg text-[10px] font-bold border transition-all ${state === 'approved' ? 'bg-green-100 border-green-200 text-green-700' : 'border-[#1f2937] text-gray-400 hover:text-green-600'}`}
//                             >
//                               Approve
//                             </button>
//                             <button
//                               onClick={() => mark(key, 'rejected')}
//                               className={`flex-1 py-1.5 rounded-lg text-[10px] font-bold border transition-all ${state === 'rejected' ? 'bg-red-100 border-red-200 text-red-700' : 'border-[#1f2937] text-gray-400 hover:text-red-600'}`}
//                             >
//                               Reject
//                             </button>
//                           </div>
...
//               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pt-6 border-t border-[#1f2937]">
...
//                   <div className="bg-[#000000] rounded-xl p-5 border border-[#1f2937] space-y-3">
//                     {isEditingBank ? (
...
//                           <input
//                             type="text"
//                             className="w-full bg-[#0a0a0a] border border-[#1f2937] rounded-lg px-3 py-2 text-xs font-bold text-gray-300 focus:ring-2 focus:ring-blue-500 outline-none transition-all shadow-sm"
...
//                               });
//                             }}
//                             className="px-3 py-2 bg-[#111111] text-gray-400 rounded-lg text-[10px] font-black uppercase tracking-widest hover:bg-[#1f2937] transition-all"
//                           >
//                             Cancel
//                           </button>
//                         </div>
...
//                           <input
//                             type="text"
//                             className="w-full bg-[#0a0a0a] border border-[#1f2937] rounded-lg px-3 py-2 text-xs font-bold text-gray-300 focus:ring-2 focus:ring-rose-500 outline-none transition-all shadow-sm"
...
//                           <span key={idx} className="px-2 py-0.5 bg-[#0a0a0a] border border-[#1f2937] text-gray-400 rounded-md text-[9px] font-bold">
//                             {skill.trim()}
//                           </span>
//                         ))}
...
//               <div className="bg-[#0a0a0a] border border-[#1f2937] rounded-xl p-5 space-y-4">
//                 <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest border-b border-[#1f2937] pb-2">Record Hash</p>
...
//                   <p className="text-xs font-bold text-gray-300">{data.createdAt ? new Date(data.createdAt).toLocaleDateString() : 'N/A'}</p>
//                 </div>
//               </div>
//             </div>
//           </div>
...
const MetaRow = ({ label, value }) => (
  <div className="flex flex-col gap-1 p-3 bg-[#000000]/50 rounded-xl border border-[#1f2937] transition-all hover:bg-[#0a0a0a] hover:shadow-sm">
    <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">{label}</span>
    <span className="text-sm font-bold text-gray-300 break-words">{value || "---"}</span>
  </div>
);
...
export default function PersonalDocuments() {
  ...
  if (!data) return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#000000] to-[#0a0a0a] p-6">
      <div className="bg-[#0a0a0a] rounded-lg p-8 shadow-md text-center max-w-sm w-full border border-[#1f2937]">
        <FaUser size={32} className="mx-auto text-gray-300 mb-4" />
        <h2 className="text-xl font-bold text-gray-300 mb-2">Unavailable</h2>
        <p className="text-sm text-gray-500 mb-6">Candidate profile not found.</p>
  ...
  if (Array.isArray(data)) {
    ...
    return (
      <div className="w-full min-h-screen bg-gradient-to-br from-[#000000] to-[#0a0a0a] p-0 md:p-2 lg:p-4 pb-20">
        {/* Page Header Section */}
        <div className="px-6 py-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-black text-gray-200 tracking-tight flex items-center gap-3">
              Personal Documents
          ...
          <div className="flex items-center gap-3">
            <button onClick={fetchData} className="h-11 px-5 text-xs font-black text-gray-400 bg-[#0a0a0a] border border-[#1f2937] shadow-sm rounded-xl hover:bg-[#000000] transition-all flex items-center gap-2 uppercase tracking-widest">
        ...
        <div className="mx-6 mb-6 p-4 bg-[#0a0a0a]/80 backdrop-blur-md rounded-2xl shadow-xl border border-white/50">
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="relative flex-1 min-w-[300px] group">
              ...
              <input
                ...
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full pl-12 pr-4 py-3.5 bg-[#000000] border-transparent rounded-xl text-sm font-bold text-gray-300 placeholder:text-gray-400 focus:bg-[#0a0a0a] focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none shadow-inner"
              />
              {searchQuery && (
                <button
                  onClick={() => setSearchQuery("")}
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-300 hover:text-gray-500 transition-colors bg-[#111111] p-1.5 rounded-lg"
                >
                  <FaTimes size={10} />
                </button>
              )}
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative" ref={roleDropdownRef}>
                <button
                  ...
                  className={`h-12 px-5 text-xs font-black rounded-xl transition-all flex items-center gap-2 border uppercase tracking-widest ${roleFilter
                    ...
                    : 'bg-[#0a0a0a] text-gray-400 border-[#1f2937] hover:border-blue-200'
                    }`}
                >
                ...
                {isRoleDropdownOpen && (
                  <div className="absolute z-50 mt-2 w-64 bg-[#0a0a0a] border border-[#1f2937] rounded-xl shadow-2xl overflow-hidden py-1 animate-in fade-in slide-in-from-top-2">
                    <div className="p-3 border-b border-gray-50 bg-[#000000]/50">
                      <div className="relative">
                        <FaUserTie className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-xs" />
                        <input
                          type="text"
                          className="w-full py-2 pl-9 pr-3 text-xs bg-[#0a0a0a] border border-[#1f2937] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 font-bold"
                    ...
                    <div className="max-h-60 overflow-y-auto">
                      <div
                        onClick={() => { setRoleFilter(''); setIsRoleDropdownOpen(false); setRoleSearchQuery(''); }}
                        className={`px-4 py-2.5 text-xs font-bold cursor-pointer hover:bg-blue-50 transition-colors ${!roleFilter ? 'text-blue-600 bg-blue-50/80' : 'text-gray-400'}`}
                      >
                        ALL DEPARTMENTS
                      </div>
                      {roles
                        ...
                        .map((r) => (
                          <div
                            key={r._id}
                            onClick={() => { setRoleFilter(r.name); setIsRoleDropdownOpen(false); setRoleSearchQuery(''); }}
                            className={`px-4 py-2.5 text-xs font-bold cursor-pointer hover:bg-blue-50 transition-colors ${roleFilter === r.name ? 'text-blue-600 bg-blue-50/80' : 'text-gray-400'}`}
                          >
                            {r.name.toUpperCase()}
                          </div>
                        ))}
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  value={dateFilter}
                  onChange={(e) => setDateFilter(e.target.value)}
                  className="h-12 pl-12 pr-4 bg-[#0a0a0a] border border-[#1f2937] rounded-xl text-xs font-black text-gray-400 uppercase tracking-widest focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none cursor-pointer hover:border-blue-200"
                />
              </div>
                      ...
                      <div className="flex items-center justify-center gap-1">
                        {uploaded ? (
                          <>
                            ...
                            <button
                              onClick={() => openFile(doc.filePath)}
                              className="p-1 rounded bg-[#000000] text-gray-500 hover:bg-gray-800 hover:text-white transition-all"
                              title="Download"
                            >
                              <FaDownload size={10} />
                            </button>
                  ...
                  <tr key={candId} className="hover:bg-[#000000] transition-colors">
                    <td className="p-2 text-center">
                      <div className="flex items-center justify-center gap-3">
                        ...
                        <div>
                          <div className="text-xs font-bold text-gray-300">{candName}</div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#000000] to-[#0a0a0a] p-0 md:p-4 lg:p-6">
      <div className="w-full space-y-8 p-4">
        {/* Header Section */}
        <div className="bg-[#0a0a0a] rounded-2xl p-6 shadow-md border border-[#1f2937] flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="w-full pb-12">
          ...
          <div className="w-full space-y-12">
            ...
            <section>
              ...
              <div className="bg-[#0a0a0a] rounded-xl shadow-md border border-[#1f2937] overflow-hidden">
                  ...
                  <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-gray-50">
                      {docKeys.map((key) => {
                        ...
                        return (
                          <tr key={key} className="group hover:bg-[#000000] transition-colors">
                            ...
                            <td className="px-6 py-4">
                              <code className="text-[10px] text-gray-500 font-bold font-mono bg-[#000000] px-3 py-1 rounded-lg border border-[#1f2937] block max-w-[200px] truncate">
                                {doc.fileName || '--'}
                              </code>
                            </td>
                            <td className="px-6 py-4">
                              <div className="flex items-center justify-center gap-2">
                                <button
                                  onClick={() => openFile(doc.filePath)}
                                  disabled={!uploaded}
                                  className={`p-2 rounded-lg transition-all ${uploaded ? 'bg-blue-600 text-white hover:bg-blue-700 shadow-sm' : 'bg-[#000000] text-gray-300 cursor-not-allowed'}`}
                                  title="View Document"
                                >
                                  <FaEye size={12} />
                                </button>
                                <button
                                  onClick={() => openFile(doc.filePath)}
                                  disabled={!uploaded}
                                  className={`p-2 rounded-lg border transition-all ${uploaded ? 'border-[#1f2937] bg-[#0a0a0a] text-gray-400 hover:border-gray-900 hover:text-gray-200 shadow-sm' : 'bg-[#000000] border-transparent text-gray-300 cursor-not-allowed'}`}
                            ...
                            <td className="px-6 py-4">
                              <div className="flex items-center justify-end gap-2">
                                <button
                                  onClick={() => mark(key, 'approved')}
                                  className={`px-3 py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-widest border transition-all flex items-center justify-center gap-1.5 ${state === 'approved' ? 'bg-green-100 border-green-200 text-green-700 shadow-sm' : 'border-[#1f2937] bg-[#0a0a0a] text-gray-400 hover:border-green-500 hover:text-green-500'}`}
                                >
                                  <FaCheck size={10} /> Approve
                                </button>
                                <button
                                  onClick={() => mark(key, 'rejected')}
                                  className={`px-3 py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-widest border transition-all flex items-center justify-center gap-1.5 ${state === 'rejected' ? 'bg-red-100 border-red-200 text-red-700 shadow-sm' : 'border-[#1f2937] bg-[#0a0a0a] text-gray-400 hover:border-red-500 hover:text-red-500'}`}
                                >
            ...
            {/* Extra Details */}
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 pt-12 border-t border-[#1f2937]">
              {/* Bank Details Section */}
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                ...
                <div className="bg-[#0a0a0a] rounded-xl p-5 shadow-sm border border-[#1f2937] space-y-4">
                  {isEditingBank ? (
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          type="text"
                          className="w-full bg-[#0a0a0a] border border-[#1f2937] rounded-lg px-4 py-2 text-sm font-bold text-gray-300 focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                          value={bankForm.bankName}
                          onChange={(e) => setBankForm({ ...bankForm, bankName: e.target.value })}
                          placeholder="e.g. HDFC Bank"
                        />
                      ...
                      <div className="flex gap-2 pt-2">
                        ...
                        <button
                          ...
                          className="px-4 h-9 bg-[#111111] text-gray-400 rounded-lg text-[10px] font-bold uppercase tracking-widest hover:bg-[#1f2937] transition-all"
                        >
                          Cancel
                        </button>
                      </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <MetaRow label="IFSC Code" value={data.documents?.bankDetails?.ifscCode} />
                      {!data.documents?.bankDetails?.bankName && (
                        <p className="text-[10px] font-bold text-gray-400 italic text-center py-4 bg-[#000000] rounded-xl border border-dashed border-[#1f2937] mt-2">No bank details provided</p>
                      )}
                    </div>
                  )}
                </div>
                  ...
                  {isEditingEmergency1 ? (
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          type="text"
                          className="w-full bg-[#0a0a0a] border border-[#1f2937] rounded-lg px-4 py-2 text-sm font-bold text-gray-300 focus:ring-2 focus:ring-rose-500 outline-none transition-all"
                          value={emergency1Form.name}
                          onChange={(e) => setEmergency1Form({ ...emergency1Form, name: e.target.value })}
                          placeholder="Contact Name"
                        />
                    ...
                    <div className="space-y-3">
                      ...
                      <MetaRow label="Relation" value={data.documents?.emergencyContact1?.relationship} />
                      {!data.documents?.emergencyContact1?.name && (
                        <p className="text-[10px] font-bold text-gray-400 italic text-center py-4 bg-[#000000] rounded-xl border border-dashed border-[#1f2937] mt-2">No contact provided</p>
                      )}
                    </div>
                  )}
                </div>
                  ...
                  {isEditingEmergency2 ? (
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          type="text"
                          className="w-full bg-[#0a0a0a] border border-[#1f2937] rounded-lg px-4 py-2 text-sm font-bold text-gray-300 focus:ring-2 focus:ring-teal-500 outline-none transition-all"
                          value={emergency2Form.name}
                          onChange={(e) => setEmergency2Form({ ...emergency2Form, name: e.target.value })}
                          placeholder="Contact Name"
                        />
